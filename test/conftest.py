...
def client_node():
    ...
    return make_cpu_cryptosystem_client_node(
        client_node_ip,
        client_node_port,
        setup_node_ip,
        setup_node_port,
